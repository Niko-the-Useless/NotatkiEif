...
## Klasyfikacja
- Szeregowe
	 Licznik złożony z n przerzutników, który jest w stanie zliczyć do $2^n$ impulsów
- Równoległe
## Rodzaje
- Synchroniczne
	 przerzutniki sterowane zegarem
- Asynchroniczne
	 przerzutniki są sterowane wyjściami przerzutników poprzedzających
- liczące w przód
- liczące w tył
- rewersyjne
- Pierścieniowe
